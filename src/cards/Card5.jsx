      ...
      >
        {page == 5 && (
          <>
            ...
            <div className="relative w-full h-1/2 pl-5 top-16">
              <img
                src="/invitation.jpg"
              ...
              <img
                src="/invitation.jpg"
                className="w-48 h-36 skew-y-12 shadow-md shadow-green-200 absolute z-20 left-12 rounded-md opacity-80"
              />
              <img
                src="/invitation.jpg"
                className="w-48 h-36 skew-y-12 shadow-md shadow-green-200 absolute z-10 left-24 rounded-md opacity-60"
              />
            </div>
            ...
            <div className="w-full z-30 flex flex-col items-center text-lg">
              <span className="flex justify-center z-30 pl-4 pr-1 text-[#1ed760] font-bold relative">
                Do not forget to carry your plane ticket and the puzzle piece
                with it! It's going to be a fun ride!
              </span>
            </div>
