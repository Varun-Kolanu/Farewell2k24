...
const Card3 = ({ page, handleNext, handlePrev }) => {
	return (
		<div
			className={`perspective-3 ${page > 3 && "w-0 h-0"} absolute cursor-default`}
					...
					<>
						<div className="pl-5 pr-3 relative mb-2">
							<div className="flex flex-col">
								<span className="text-white text-[2rem] space-x-3 font-bold font-sans">
									Join us for a dinner to celebrate this huge milestone!
								</span>
							</div>
						</div>
