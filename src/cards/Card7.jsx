...
const Card7 = ({ page, handleNext, handlePrev }) => {
	return (
		<div className={`perspective-7 ${page > 7 && "w-0 h-0"} absolute cursor-default`}>
			<div
					...
					<>
						...
						<div className="p-9 ">
							<div className="text-[1.7rem] space-x-3 font-bold font-sans z-10 relative -top-6">
								<span className="text-[#c5efc9] relative -left-3 [word-spacing:5px]">
						...
						<span className="text-[#c5efc9] text-lg font-bold">See you at 17 Apr 👋</span>
					</>
				)}
			</div>
		</div>
